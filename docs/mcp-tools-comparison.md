...
| Tool surface                            | ✅ 250+                                                 | ✅ 70+                        | ✅ 43 grouped            | ~11            | ~30                      | ~52          | ✅ ~288                         | ~30 tools + 7 resources                                        | growing             | n/a (assistant)               |
...
| Embedded domains / community packs      | ✅ 18 embedded domain groups; community packs separate  | ⭐ 10 (Cinemachine/Terrain/…) | 🟡 tool groups          | custom         | —                        | module stubs | 🟡 package-gated               | 🟡 custom `McpToolBase`                                        | —                   | —                             |
| AI client auto-config                   | ⭐ 18+ (Cursor/Claude/Cline/Codex/VS Code/…)           | ⭐ 14+                        | ⭐ broad matrix          | manual         | Claude plugin            | generic      | ❌ manual                       | ⭐ Cursor/Claude/Codex/Copilot/OpenCode + project-local configs | n/a                 | n/a                           |
...
- **Open MCP** — this project. [GitHub](https://github.com/AlexeyPerov/Unity-Open-MCP) · MIT.
