...
|---|---|---|
| **Regular user (npm)** *(recommended)* | Developers who want the published npm package, no monorepo checkout | `npx -y unity-open-mcp@0.8.3`; bridge + verify from published sources; domain deps off; skill on |
