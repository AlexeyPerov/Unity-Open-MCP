...
| Particle System | `particle_system` | shipped | (built-in) |
| Animation | `animation` | shipped | (built-in) |
...
| Tool index | `mcp-server/src/tools/index.ts` | Import + add to a plan array (`M16_PLAN10_TOOLS` for navigation, `M16_PLAN10_INPUTSYSTEM_TOOLS` for Input System, `M16_PLAN10_PROBUILDER_TOOLS` for ProBuilder, `M16_PLAN10_PARTICLESYSTEM_TOOLS` for Particle System, `M16_PLAN10_ANIMATION_TOOLS` for Animation, or a new one per pack) + spread into `ALL_TOOLS` |
