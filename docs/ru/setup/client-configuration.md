...
Это канонический справочник по подключению MCP-клиента к одному проекту Unity.
Руководства по установке ссылаются сюда за клиент-специфичными расположениями
файлов и оболочками конфигурации.
