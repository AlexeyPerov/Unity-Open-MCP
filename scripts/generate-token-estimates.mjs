...
//
// Why codegen (not a hand-maintained list): the catalog grows continuously.
// A second hand-maintained list would drift from the real schemas within one
// release. Importing the live TS source means the generated table can never
// disagree with what an agent actually receives.
//
