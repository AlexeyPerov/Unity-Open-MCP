...
export function generateSkillMarkdown(
  ...
  lines.push("");
  lines.push(`> Auto-generated by \`unity_agent_generate_skill\` on ${now}.`);
  ...
  if (implementedTools.length > 0) {
    ...
    lines.push("");
    lines.push("All tools are prefixed `unity_open_mcp_*` or `unity_agent_*`.");
    lines.push("");
  ...
  lines.push("---");
  lines.push("");
  lines.push("This file was auto-generated. To refresh, call `unity_agent_generate_skill` with `\"write\": true`.");
