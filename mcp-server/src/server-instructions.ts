...
export function buildServerInstructions(): string {
  return [
    ...
    "use tool_name for one exact schema, or query/group/tag filters with paging.",
    "Use canonical asset_path, game_object_path, component_type and property_path.",
    "If list refresh is unavailable, manage_tools(action=\"invoke\", tool_name, arguments)",
    "uses the activated target’s normal route and protections. Prefer the",
    ...
    "",
    "Prefer typed live edits; never directly edit open/dirty scene or asset YAML.",
    "For necessary offline-file repair, preserve GUID/fileID and intended-scene identity;",
    "reimport/reserialize and run scoped validation before trusting the change.",
