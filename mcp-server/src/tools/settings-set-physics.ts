...
export const settingsSetPhysics = makeTool(
    ...
    "physics2DGravity ([x,y]). Returns the list of applied keys + any per-key warnings.",
  {
    required: ["fields", "paths_hint"],
        properties: {
          ...
          paths_hint: { ...PATHS_HINT_TYPE, description: "Mutation scope — pass [\"ProjectSettings/DynamicsManager.asset\"]. There is no " + "whole-project fallback." },
          gate: { ...GATE_PROP },
        },
  },
);
