...
export const sceneviewSetCamera: Tool = {
  name: "unity_open_mcp_sceneview_set_camera",
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      paths_hint: {
        ...
        items: { type: "string" },
        description:
          "Mutation scope — active scene path (records editor-camera move in gate history).",
      },
      gate: {
