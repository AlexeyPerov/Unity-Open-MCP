...
const targetSchema = {
  ...
  paths_hint: { ...PATHS_HINT_TYPE, description: "Mutation scope — the host scene path. When a new TerrainLayer asset is " + "created (layer_path under Assets/ and a fresh layer), include the layer " + ".terrainlayer asset path too. No whole-project fallback." },
  gate: { ...GATE_PROP },
};

export const terrainPaintLayer = makeTool(
