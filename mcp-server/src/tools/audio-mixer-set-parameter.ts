...
export const audioMixerSetParameter: Tool = {
  name: "unity_open_mcp_audio_mixer_set_parameter",
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      paths_hint: {
        type: "array",
        items: { type: "string" },
        description: "Mutation scope — the mixer asset path. No whole-project fallback.",
      },
