  ...
  inputSchema: {
    ...
    properties: {
      ...
      paths_hint: {
        ...
        items: { type: "string" },
        description:
          "Mutation scope — include BOTH source and destination paths so the gate can detect dangling references. No whole-project fallback.",
      },
      gate: {
