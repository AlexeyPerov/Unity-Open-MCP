...
// full gate path.
export const skyboxSet: Tool = {
  name: "unity_open_mcp_skybox_set",
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      paths_hint: {
        ...
        items: { type: "string" },
        description:
          "Mutation scope — the active scene path (skybox is a scene-environment " +
          "setting) and/or the material asset path. There is no whole-project " +
          "fallback.",
      },
