...
### Команды проекта и асинхронные задачи
...
с прогрессом, идемпотентностью, сохранённым результатом и честной отменой.

> **Пример:** «Опиши проектную команду генерации уровня, запусти её как задачу и
> дождись проверенного результата.»
