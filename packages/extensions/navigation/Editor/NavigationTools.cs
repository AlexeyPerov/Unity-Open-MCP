...
// package's declared minimum). The bridge's JSON handle contract is built on
// the stable int instance ID, so the deprecated int API is used deliberately
// here. See packages/bridge/Editor/ObjectRefs/ObjectHandle.cs for the canonical
// rationale.
...
{
    // M16 Plan 10 / T6.6.2 — NavMesh (AI Navigation) extension pack.
    //
