...
//
// Compile-gated by UNITY_OPEN_MCP_EXT_INPUTSYSTEM. See InputSystemTools.cs
// for the gate rationale. Ported verbatim (logic, JSON schema) from the
// former standalone extension pack — only the namespace changed.
