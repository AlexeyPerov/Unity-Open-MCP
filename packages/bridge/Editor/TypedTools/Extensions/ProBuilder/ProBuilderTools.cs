...
//
// Compile-gated by UNITY_OPEN_MCP_EXT_PROBUILDER. The owning sub-asmdef
// (com.alexeyperov.unity-open-mcp-bridge.ProBuilder.Editor) carries
// `defineConstraints: ["UNITY_OPEN_MCP_EXT_PROBUILDER"]` and references
// Unity.ProBuilder; the bridge root asmdef sets the define via
...
namespace UnityOpenMcpBridge.Extensions.ProBuilderExt
{
    ...
    public static class ProBuilderTools
    {
        ...
        [BridgeTool("unity_open_mcp_probuilder_create_shape",
            ...
            Lifecycle = LifecyclePolicy.EditorSettle, Group = "probuilder")]
        ...
        [BridgeTool("unity_open_mcp_probuilder_get_mesh_info",
            ...
            ReadOnlyHint = true,
            Gate = GateMode.Off,
            Lifecycle = LifecyclePolicy.None, Group = "probuilder")]
        [System.ComponentModel.Description(
