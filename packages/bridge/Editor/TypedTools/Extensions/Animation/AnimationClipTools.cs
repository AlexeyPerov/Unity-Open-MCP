...
// domain tools — AnimationClip half.
//
// Compile-gated by UNITY_OPEN_MCP_EXT_ANIMATION. See AnimatorTools.cs for the
// gate rationale. Ported verbatim (logic, tool ids, JSON schema, gate
...
{
    // M16 Plan 10 / T6.6.10 → M18 Plan 3 — AnimationClip half of the Animation
    // embedded tools.
    //
