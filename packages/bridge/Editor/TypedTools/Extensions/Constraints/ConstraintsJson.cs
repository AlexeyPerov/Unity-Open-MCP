...
//
// Shared helpers for the Constraints embedded domain tools: target
// resolution, JSON envelope builders. The PositionConstraint /
// RotationConstraint / AimConstraint / ParentConstraint / ScaleConstraint
// and LODGroup types live in the built-in engine modules
// (UnityEngine.AnimationModule for constraints, UnityEngine.LODModule for
// LODGroup) and are present in every Unity install, so this domain ships
// UNGATED — no UNITY_OPEN_MCP_EXT_CONSTRAINTS define, no sub-asmdef
