...
namespace UnityOpenMcpBridge
{
    public partial class UnityOpenMcpBridgeWindow
    {
        ...
        private static readonly (string Label, string Path, string Tooltip)[] DocLinks =
        {
            ...
            ("Manual setup", "docs/setup/manual-setup.md", "Do-it-yourself Unity package and MCP installation."),
            ("Client configuration", "docs/setup/client-configuration.md", "Client paths, config envelopes, and environment."),
            ...
            ("MCP tools API", "docs/api/mcp-tools.md", "Tool overview and focused contract references."),
